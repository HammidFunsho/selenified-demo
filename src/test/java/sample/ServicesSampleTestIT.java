...
public class ServicesSampleTestIT extends Selenified {
    ...
    public void sampleServicesAddressTest() {
        ...
        jsonObject.addProperty("lat", 37.7931177802915);
        jsonObject.addProperty("lng", -122.3930782197085);
//        jsonObject.addProperty("types", "street number");

        call.get("", request).assertContains(jsonObject);
        // verify no issues
        finish();
    }
